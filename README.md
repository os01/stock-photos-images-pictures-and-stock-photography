# stock-photos-images-pictures-and-stock-photography
...
[Pixarik](https://www.pixarik.com/) - Up and coming platform, stock photo marketplace which has a lot of interesting fucntionality liek background removal, image/art generation. A high-resolution and absolutely free photos stock site. Has API and other features like AI /deep learning based tools to generate new art/ images based on the style provided, background removal and more
...
Resource that have huge colleciton of CC0 images/photos/illustations free to download:

* [Pixarik](https://www.pixarik.com/) - A high-resolution and absolutely free photos stock site. Has API and other features like AI /deep learning based tools to generate new art/ images based on the style provided, background removal and more
